...
public class EventDetail extends JFrame {
	...
	public EventDetail() {
		...
		lblNewLabel_1.setIcon(new ImageIcon(EventDetail.class.getResource("/gaming/esports-gaming-event-gamer-looks-crowd.jpg")));
		...
		comboBox.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (comboBox.getSelectedItem().equals("First Person Shooter (FPS)")) {
					...
					lblNewLabel_2.setIcon(new ImageIcon(EventDetail.class.getResource("/gaming/1502212035_preview_download.jpg")));
					...
					lblNewLabel_2.setIcon(new ImageIcon(EventDetail.class.getResource("/gaming/League_of_Legends_icon.png")));
					...
					lblNewLabel_2.setIcon(new ImageIcon(EventDetail.class.getResource("/gaming/War_Shield.png")));
				}
				} catch (Exception e1) {
					e1.printStackTrace();
				}
