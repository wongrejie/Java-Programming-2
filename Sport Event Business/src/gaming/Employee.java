	...
	public Employee() {
		...
		btnUpload.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				File file = new File("/Sport Event Business/src/gaming/EmployeeList.txt");
		...
		lblNewLabel.setIcon(new ImageIcon(Employee.class.getResource("/gaming/maxresdefault.jpg")));
