...
public class Admin extends JFrame {
	...
	public Admin() {
		...
		lblNewLabel_1.setIcon(new ImageIcon(Admin.class.getResource("/gaming/ultimate_Gamer-removebg-preview.png")));
		...
		lblNewLabel.setIcon(
				new ImageIcon(Admin.class.getResource("/gaming/159-1597906_esl-wallpaper-ninjas-in-pyjamas-black-and-white.jpg")));
