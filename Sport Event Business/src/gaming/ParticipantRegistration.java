...
public class ParticipantRegistration extends JFrame {
	...
	public ParticipantRegistration() {
		...
		lblNewLabel_2.setIcon(new ImageIcon(ParticipantRegistration.class.getResource("/gaming/photo-1542751371-adc38448a05e.jpg")));
		...
		btnUpload.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try { //2.2 Exception Handling
					File file = new File("/Sport Event Business/src/gaming/ParticipantList.txt");
		...
		lblNewLabel_4.setIcon(new ImageIcon(ParticipantRegistration.class.getResource("/gaming/e16d4219e671bac00d1c23131e6d723f.jpg")));
		lblNewLabel_4.setBounds(490, 0, 442, 64);
		panel.add(lblNewLabel_4);
		
		JLabel lblNewLabel_3 = new JLabel("");
		lblNewLabel_3.setIcon(new ImageIcon(ParticipantRegistration.class.getResource("/gaming/photo-1542751371-adc38448a05e.jpg")));
