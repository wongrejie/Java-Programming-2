...
//		System.out.println("---------------------------------------------------------");
		...
		GreenApple objGreenApple= new GreenApple("Green Apple","Sour",12,6,60);
		System.out.println(objGreenApple.toString());
		System.out.println(objGreenApple.Benefits());
		System.out.println("---------------------------------------------------------");
		
		RedApple objRedApple= new RedApple("Red Apple","Sweet",24,8,80);
		...
		Strawberry objStrBerry= new Strawberry("Strawberry","Honeoye","Bright Red","medium",35,6);
